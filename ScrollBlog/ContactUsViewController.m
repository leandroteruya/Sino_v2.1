...
@synthesize mapView,titleName,address,emailNow,callNow,blackBack;
...
- (void)viewDidLoad
{
    ...
    titleName.text = [dataSent objectAtIndex:3];
    address.text = [dataSent objectAtIndex:4];
    pNumber = [dataSent objectAtIndex:5];
    email = [dataSent objectAtIndex:6];
    
    lat = [[dataSent objectAtIndex:1] doubleValue];
    longti = [[dataSent objectAtIndex:2] doubleValue];
	...
	MapViewAnnotation *newAnnotation = [[MapViewAnnotation alloc] initWithTitle:[NSString stringWithFormat:@"%@",[dataSent objectAtIndex:0]] andCoordinate:location];
